...
export default function About() {
  ...
  const Stephanie = {
    ...
    text: "Hello, world! I'm currently a third-year undergraduate student at California State Polytechnic University, Pomona, graduating in 2023 with a Bachelor's Degree in Computer Science. My passion for helping others has continuously driven me to find opportunities to grow and expand my knowledge & experience. I also love planning and organizing, and I'm so excited for Crumble to increase productivity and motivation for others as we continue to improve!",
  };

  const Abhiraj = {
    name: "Abhiraj Chatterjee",
    text: "Hi! I'm currently a rising junior at Penn State University. I'm planning on graduating in 2023 with a B.S. in Computer Science. I'm a motivated student adept at working with customers, team members and project leaders to accomplish software engineering and updating tasks according to timelines. I enjoy creating things that live on the internet, whether that be websites, applications, or anything in between.",
  };
